                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="section-title is-sticky" style={{top: '80px'}}>
                                ...
                                <a href="#" className="btn btn-primary-round btn-round">See All Services<i className="fas fa-arrow-right pl-3"></i></a>
                            </div>
                        </div>
