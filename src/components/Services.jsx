                ...
                <div className="container">
                        ...
                        <div className="col-md-6 col-lg-3 mb-sm-5 mb-4">
                            <div className="category-box category-box-style-02 text-center">
                                ...
                                <ul className="category-list">
                                    <li><a href="e-commerce-strategy">E-commerce strategy</a></li>
                    ...
                    <div className="row">
                        <div className="col-12 d-md-flex justify-content-center align-items-center">
                            ...
                            <a href="#" className="btn btn-primary-round btn-round mx-0 mx-md-3">Get A Quote<i className="fas fa-arrow-right pl-3"></i></a>
                        </div>
                    </div>
                </div>
            </section>
